...
ActiveRecord::Schema.define(version: 20180614083951) do
  ...
  create_table "confirm_imgs", force: :cascade do |t|
    t.string "image_analyst"
    t.string "test"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "std_number", default: "", null: false
    t.string "std_major", default: "", null: false
